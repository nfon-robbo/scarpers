...
iPhone users can sync sleep stages, resting heart rate, HRV, steps and active
calories into Scarpers automatically — no Apple Developer account, no extra
server. Anything your watch or phone writes into Apple Health (Garmin, Apple
Watch, Whoop, Oura, Fitbit) comes through.
...
- Runs are **not** imported this way — use Strava or a FIT file upload.
