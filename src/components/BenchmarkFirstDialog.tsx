...
export default function BenchmarkFirstDialog({
  open, onOpenChange, onScheduleBenchmark, onSkip, scheduling,
}: Props) {
      ...
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription className="leading-relaxed">
            ...
            guess. Skipping is one tap; you can benchmark later at any time.
          </DialogDescription>
        </DialogHeader>

        <div className="space-y-2 pt-2">
          <Label htmlFor="benchmark-date" className="text-xs">Benchmark date</Label>
          <Input
            id="benchmark-date"
            type="date"
            value={dateIso}
        ...
        <DialogFooter className="flex-col sm:flex-col gap-2 sm:space-x-0">
          ...
          >
            ...
            {scheduling ? "Scheduling…" : "Schedule benchmark first (recommended)"}
          </Button>
