...
const H2 = ({ children }: { children: React.ReactNode }) => (
  <h2 className="mt-3 text-3xl sm:text-5xl font-bold tracking-tight leading-[1.05]" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
    {children}
  </h2>
);
      ...
      <section className="relative isolate min-h-screen flex flex-col overflow-hidden">
        ...
        <div className="relative z-10 flex-1 flex items-end">
          <div className="px-5 sm:px-10 pb-20 sm:pb-28 max-w-2xl">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight leading-[0.95] text-white drop-shadow-lg" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
              AI Running<br />Coach
            </h1>
        ...
        <div className="relative max-w-6xl mx-auto px-5 py-20 sm:py-28">
          <div className="grid md:grid-cols-2 gap-12 md:gap-8 items-center">
            <div className="order-1 md:order-1">
              ...
              <h2 className="mt-3 text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight leading-[0.95]" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
                Your AI plan,<br />
          ...
          <div className="mt-16 grid md:grid-cols-3 gap-6">
            {STEPS.map((s) => (
              <article key={s.n} className="text-center">
                ...
                <h3 className="mt-2 text-xl font-bold" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>{s.title}</h3>
            ...
            <div className="grid grid-cols-2 gap-3">
              {PLANS.map((p) => (
                <div key={p.distance} className={`rounded-2xl border border-border/50 bg-background/70 backdrop-blur p-5 ${p.distance === "Ultra" ? "col-span-2" : ""}`}>
                  ...
                  <h3 className="mt-1 text-2xl font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>{p.distance}</h3>
            ...
            {[
              ...
              <article key={c.title} className="rounded-2xl border border-border/50 bg-card/60 backdrop-blur p-7">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-bold" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>{c.title}</h3>
                </div>
