...
import { RaceTimePredictorWidget } from "@/components/RaceTimePredictorWidget";
...
const TrainingPlanPage = () => {
  ...
  useEffect(() => {
    const onPlanChange = () => { loadSavedPlan(); };
    window.addEventListener("plan-undo-changed", onPlanChange);
