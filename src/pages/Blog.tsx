  ...
  return (
    ...
    >
      <div className="text-center mb-10">
        ...
        <h1 className="text-4xl sm:text-5xl font-bold tracking-tight" style={{ fontFamily: "'Cabinet Grotesk', sans-serif" }}>
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          {posts.map((post) => (
            ...
            >
              ...
              <div className="p-5">
                <h2 className="text-lg font-bold text-foreground group-hover:text-primary transition-colors line-clamp-2" style={{ fontFamily: "'Cabinet Grotesk', sans-serif" }}>
                  {post.title}
                </h2>
                {post.excerpt && (
